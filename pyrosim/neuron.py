...
class NEURON: 
    ...
    def Update_Hidden_Or_Motor_Neuron(self, neurons, synapses):
        ...
        for synapse in synapses:
            if synapses[synapse].Get_Target_Neuron_Name() == self.Get_Name():
                presynaptic_name = synapses[synapse].Get_Source_Neuron_Name()
                self.Allow_Presynaptic_Neuron_To_Influence_Me(synapses[synapse].Get_Weight(), neurons[presynaptic_name].Get_Value())
        self.Threshold()
